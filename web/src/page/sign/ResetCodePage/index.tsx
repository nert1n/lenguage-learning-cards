...
import IResetCodePage from '@/page/sign/ResetCodePage/reset-code-page.interface';
...
function ResetCodePage() {
	const {
		...
		formState: { errors },
		handleSubmit,
	} = useForm<IResetCodePage>({ mode: 'onBlur' });
	...
	async function onSubmit(answer: IResetCodePage) {
		try {
